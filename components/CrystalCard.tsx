...
export function CrystalCard({ crystal }: { crystal: Crystal }) {
  return (
    <div className="glass-card flex flex-col gap-3 rounded-2xl p-6 transition-transform duration-300 hover:-translate-y-1">
      <div className="flex items-center gap-3">
        <span
          className="h-9 w-9 shrink-0 rounded-full border border-pearl/30 sparkle-overlay"
